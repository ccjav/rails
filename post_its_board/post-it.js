...
Board.prototype.createBoard = function() {
  ...
  g.className = "board";
  // var currentBoard = $("<div></div>");
  // $g.css({"background-color" : "#9e8d68", "position" : "absolute", "height" : "100%", "width" : "90%", "right" : 0, "top" : 0});
  document.getElementsByTagName('body')[0].appendChild(g);


  // var currentBoard = $('body').find(this.id)
  // console.log(currentBoard)
  // $(currentBoard).css({"background-color" : "#9e8d68", "position" : "absolute", "height" : "100%", "width" : "90%", "right" : 0, "top" : 0})
  console.log(this.id)
...
PostIt.prototype.createPostIt = function(boardSelector) {
  ...
  // g.setAttribute("id", "master");
  // var hola = document.getElementById(boardSelector);
  // console.log("hola " )
  // console.log(hola)
  // hola.appendChild(g);
  var bola = $(boardSelector);
  // $( boardSelector ).show();
  $(bola).append("<p>fsdaf</p>")
  $( "<p>fsdaf</p>" ).appendTo( bola.selector );
